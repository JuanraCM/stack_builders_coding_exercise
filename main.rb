# TODO: Crawl the first 30 entries from https://news.ycombinator.com/. Only care about the title, the number of the order, the number of comments, and points for each entry
